...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=health.v1.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
...
const file_health_v1_health_proto_rawDesc = "" +
	...
	"\rHealthService\x12H\n" +
	"\x05Check\x12\x1d.health.v1.HealthCheckRequest\x1a\x1e.health.v1.HealthCheckResponse\"\x00BAZ?github.com/go-authgate/authgate/internal/gen/health/v1;healthv1b\x06proto3"
...
var file_health_v1_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: health.v1.HealthCheckResponse.ServingStatus
...
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: health.v1.HealthCheckResponse.status:type_name -> health.v1.HealthCheckResponse.ServingStatus
	1, // 1: health.v1.HealthService.Check:input_type -> health.v1.HealthCheckRequest
	2, // 2: health.v1.HealthService.Check:output_type -> health.v1.HealthCheckResponse
